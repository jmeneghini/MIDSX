...
then
  /home/john/.local/share/JetBrains/Toolbox/apps/CLion/ch-0/232.9559.58/bin/ninja/linux/x64/ninja $targets_to_make ${EIGEN_MAKE_ARGS}
else
  /home/john/.local/share/JetBrains/Toolbox/apps/CLion/ch-0/232.9559.58/bin/ninja/linux/x64/ninja $targets_to_make 
fi
exit $?
